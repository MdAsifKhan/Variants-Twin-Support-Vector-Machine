    ...
    clear all;
    close all;
     file1 = fopen('results_Improved_ITWSVM.txt','w+');
     file2 = fopen('results_c_mu_Improved_ITWSVM.txt','w+');
...
% %    _______________________________________________________________________
     FunPara.c1=min_c1;FunPara.c2=min_c1;FunPara.c3=min_c3;FunPara.c4=min_c3;
